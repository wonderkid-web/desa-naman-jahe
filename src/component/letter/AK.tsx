  ...
  <Document>
    <Page style={styles.page}>
      ...
      <Text style={styles.letterNumber}>
        Nomor: {nomor_surat}/AK/VI/{currentYear}
      </Text>
      <Text style={styles.content}>
        Berdasarkan Surat Kematian Nomor: {nik}, dengan ini kami menerangkan
        bahwa:
      </Text>
      ...
      <Text style={styles.content}>
        Telah meninggal dunia pada tanggal {remakeDate(skDate)}. Berdasarkan pengantar dari
        RT/RW setempat, bahwa benar yang bersangkutan meninggal dunia.
      </Text>
      <Text style={styles.content}>
      ...
      <Text style={styles.content}>
        Surat keterangan ini berlaku untuk keperluan administrasi yang
        bersangkutan.
      </Text>
      <Text style={styles.content}>
