...
function RegisterPage() {
  ...
  const onSubmit: SubmitHandler<FormRegister> = async (form) => {
    ...
    if (!error) {
      ...
      toast.warning("Gagal Mendaftarkan akun");
    }
  };
  ...
  return (
    <section className="bg-gray-50 dark:bg-gray-900 min-h-[140vh]">
      <div className=" flex flex-col items-center justify-center px-6 py-8 mx-auto md:h-screen lg:py-0">
        ...
        >
          <div className="w-72 h-24 mt-2 relative">
            <Image src={logo} className="bg-green-800 pr-2 rounded-sm" alt="logo" objectFit="cover" />
          </div>
        </Link>
